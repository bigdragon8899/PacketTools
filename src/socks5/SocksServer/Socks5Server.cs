...
namespace socks5
{
    public class Socks5Server
    {
        ...
        void _server_onClientConnected(object sender, ClientEventArgs e)
        {
            ...
            SocksClient client = new SocksClient(e.Client,this);
        ...
        public event Action<DataEventArgs> OnDataSent;
        public event Action<DataEventArgs> OnDataReceived;
        ...
        public void TriggerServerDataReceived(DataEventArgs e)
        {
